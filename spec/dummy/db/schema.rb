...
ActiveRecord::Schema.define(version: 20130828081710) do
  ...
  add_index "rapidfire_question_groups", ["tenant_id", "tenant_type"], name: "index_rapidfire_question_groups_on_tenant_id_and_tenant_type"
